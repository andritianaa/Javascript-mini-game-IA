...
var p4 = {
   ...
   */
    ...
    // On colore la case
	  this.dom_plateau[row][column].className = 'player' + player;
    // On compte le coup
    this.coups++;
  ...
  /* Cette fonction ajoute un pion dans une colonne */
    ...
    switch (this.game_status) {
      case -1: 
	   ...
	   document.getElementById("wrapper").appendChild(buttonElem);
        break;
      case 1:
        //window.alert("Victoire du player 1"); 
		var txtElem = document.createElement('h2');
	   txtElem.id='resultat';
	   var txt = document.createTextNode("Victoire du player !");
	   txtElem.appendChild(txt);
	   document.getElementById("banniere").appendChild(txtElem);
	   var buttonElem= document.createElement('button');
	   buttonElem.id='bouton';
	   ...
	   document.getElementById("wrapper").appendChild(buttonElem);
        break;
      case 2:
       // window.alert("Victoire du player 2"); 
	   var txtElem = document.createElement('h2');
	   txtElem.id='resultat';
	...
	getTab: function(){
		...
		for (var i = this.n - 1; i >= 0; i--){
			var string = "";
			for (var j = 0 ; j < this.m ; j++){
				if(this.dom_plateau[i][j].className == "player1"){
					string+="1 ";
					resTab[i].push(1);
				}else if(this.dom_plateau[i][j].className == "player2") {
					string+="2 ";
					resTab[i].push(2);
				}else{
					string+="0 ";
